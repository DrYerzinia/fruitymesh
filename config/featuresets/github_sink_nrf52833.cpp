...
void SetBoardConfiguration_github_sink_nrf52833(BoardConfiguration* c)
{
...
void SetFeaturesetConfiguration_github_sink_nrf52833(ModuleConfiguration* config, void* module)
{
...
void SetFeaturesetConfigurationVendor_github_sink_nrf52833(VendorModuleConfiguration* config, void* module)
{
...
u32 InitializeModules_github_sink_nrf52833(bool createModule)
{
    u32 size = 0;
...
DeviceType GetDeviceType_github_sink_nrf52833()
{
    return DeviceType::SINK;
}

Chipset GetChipset_github_sink_nrf52833()
{
    return Chipset::CHIP_NRF52833;
}

FeatureSetGroup GetFeatureSetGroup_github_sink_nrf52833()
{
    return FeatureSetGroup::NRF52833_DEV_GITHUB;
}

u32 GetWatchdogTimeout_github_sink_nrf52833()
{
    return 0; //Watchdog disabled by default, activate if desired
}

u32 GetWatchdogTimeoutSafeBoot_github_sink_nrf52833()
{
